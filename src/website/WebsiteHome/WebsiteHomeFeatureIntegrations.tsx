...
export function WebsiteHomeFeatureIntegrations() {
  return (
    <WebsiteHomeFeatureWrapper>
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 rounded-lg bg-[#e6e6c6] bg-opacity-50 p-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
