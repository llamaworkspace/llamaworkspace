        ...
        <div className="lg:pr-8 lg:pt-4">
          <div className="lg:max-w-lg">
            <p className="mt-2 text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
              Chat with the latest GPT-4, Claude or Llama model, we have them
              all.
            </p>
            <p className="mt-6 text-2xl leading-8 tracking-tighter text-zinc-900">
              Avoid marrying a single AI vendor and gain access to the most
              powerful models at all times.
            </p>
          </div>
        </div>
        <Image
