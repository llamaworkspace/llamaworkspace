...
export function WebsiteHomeFeatureGpt4() {
  return (
        ...
        <div className="lg:pr-8 lg:pt-4">
          <div className="lg:max-w-lg">
            <p className="mt-2 text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
              Chat with GPT-4 in a faster, sleeker interface
            </p>
            <p className="mt-6 text-2xl font-medium leading-8 tracking-tighter text-zinc-900">
              The same powerful engine, simplified with just the functionality
              you really need.
            </p>
            {/* <p className="mt-6 text-2xl font-medium leading-8 tracking-tighter text-zinc-900">
              And for advanced users, Joia allows you to tune the AI parameters
              to better cater your needs, like writing more creative texts.
            </p> */}
          </div>
        </div>
        <Image
